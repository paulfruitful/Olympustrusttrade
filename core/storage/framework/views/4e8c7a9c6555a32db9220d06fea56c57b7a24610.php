      ...
      <font color="#888888">
        ...
        <tbody>
          <tr>
                                      ...
                                      <tr>
                                        <td align="center" class="m_-3249132211638951850h1 m_-3249132211638951850fw500 m_-3249132211638951850blue-dark m_-3249132211638951850center" style="font-size:0px;padding:0;word-break:break-word">
                                          <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000">
                                            <h1 class="m_-3249132211638951850h1 m_-3249132211638951850fw500 m_-3249132211638951850blue-dark m_-3249132211638951850center">Deposit Notification</h1>
                                          </div>
                                        </td>
                                      </tr>
                                      <tr>
        	...
        	<p>
        	   Your deposit for <?php echo e($md['payment']->currency); ?><?php echo e($md['payment']->amount); ?> on <?php echo e(env('APP_URL')); ?> was successful.
        	   <br>
...
</html><?php /**PATH /home/metawfal/olympustrusttrade.com/core/resources/views/mail/user_deposit_notification.blade.php ENDPATH**/ ?>