                    ...
                    <div class="row">
                       <div class="col-sm-12 card">
                          ...
                          <ul class="nav nav-tabs mt-5" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" id="wallet-tab" data-toggle="pill" href="#wallet" role="tab" aria-controls="wallet" aria-selected="false">Wallet Address</a>
                            </li>
                            <li class="nav-item">
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overmvoo/fortunetradeinvest.com/core/resources/views/user/profile.blade.php ENDPATH**/ ?>