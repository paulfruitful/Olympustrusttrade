                            ...
                            <div class="row ">                               
                              ...
                              <div class="col-md-6">
                                  <div class="card pad_20" >
                                      ...
                                      <h2 class="text-center">Crypto Deposit Setup</h2>
                                      <hr>
                                      <div class="form-group">
                                          <h5> <?php echo e(__('Coin Name')); ?> </h5>
                                          <input type="text" name="bank_name" value="<?php echo e(env('BANK_NAME')); ?>" class="form-control" placeholder=""  >
                                      </div>
                                      <div class="form-group">
                                          <h5> <?php echo e(__('Wallet Address')); ?> </h5>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overmvoo/fortunetradeinvest.com/core/resources/views/admin/settings.blade.php ENDPATH**/ ?>