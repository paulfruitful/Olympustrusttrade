                                                ...
                                                <div id="pay_cont" class="row">
                                                    ...
                                                    <div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <p>
                                                                <?php echo e(__('Deposit using Cryptocurrency')); ?>

                                                            </p> 
                                                           
                                                            <div align="">
                                                                <a id="pay_with_bank_dep" href="javascript:void(0)" class="btn btn_blue" >
                                                                    <?php echo e(__('Deposit with Bitcoin')); ?>
                                                            ...
                                                            <div id="bank_dets" align="" class="cont_display_none">
                                                                ...
                                                                <div class="row">              
                                                                    <div class="col-sm-12">
                                                                        <p class="text-danger"><img src="https://bitganar.com/img/Barcode.png" alt="Barcode"><br>
                                                                           <?php echo e(__('Make payment to the above bitcoin wallet address and click continue below.')); ?> 
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="row">              
                        ...
                        <form action="/user/wallet/bank_deposit" method="post">
                            ...
                            <div class="form-group">
                              <div class="input-group" >                   
                                ...
                                <input type="text" class="form-control" name="account_name"  required placeholder="Your Bitganar Username" >
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group" >                   
                                <div class="input-group-prepend " >
                                  <span class="input-group-text span_bg"><i class="fa fa-id-badge" ></i></span>
                                </div>
                                <input type="text" class="form-control" name="account_no"  required placeholder="Transaction hash/id (txid) " >
                              </div>
                            </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/62136876a34c24564127526c/1fsdt04gg';
s1.charset='UTF-8';
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overmvoo/fortunetradeinvest.com/core/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>