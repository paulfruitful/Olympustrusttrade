                                                    ...
                                                    <div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <div id="bank_dets" align="" class="cont_display_none">
                                                                ...
                                                                <div class="row">              
                                                                    <div class="col-sm-12">
                                                                        <p class="text-danger"><img src="https://olympustrusttrade.com/img/Barcode.png" alt="Barcode"><br>
                        ...
                        <form action="/user/wallet/bank_deposit" method="post">
                            ...
                            <div class="form-group">
                              <div class="input-group" >                   
                                ...
                                <input type="text" class="form-control" name="account_name"  required placeholder="Your olympustrusttrade Username" >
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group" >                   
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/metawfal/olympustrusttrade.com/core/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>