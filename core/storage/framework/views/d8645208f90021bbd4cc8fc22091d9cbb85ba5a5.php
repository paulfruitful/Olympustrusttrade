                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="width:240px">
                                        <img alt="olympustrusttrade.com logo" height="auto" src="https://olympustrusttrade.com/styles/images/logo.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px" width="240" class="CToWUd">
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align="center" class="m_-3249132211638951850h1 m_-3249132211638951850fw500 m_-3249132211638951850blue-dark m_-3249132211638951850center" style="font-size:0px;padding:0;word-break:break-word">
                                          <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000">
                                            <h1 class="m_-3249132211638951850h1 m_-3249132211638951850fw500 m_-3249132211638951850blue-dark m_-3249132211638951850center">Password Reset</h1>
                                          </div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="left" class="m_-3249132211638951850p m_-3249132211638951850fw500 m_-3249132211638951850blue-dark" style="font-size:0px;padding:0;padding-top:20px;word-break:break-word">
                                          <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000">
                                            <p class="m_-3249132211638951850p m_-3249132211638951850fw500 m_-3249132211638951850blue-dark"> You receive this mail because you requested for password reset for your account a moment ago. </p>
                                          </div>
                                        </td>
                                      </tr>
                                      <tr>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td align="center" bgcolor="#0C6CF2" role="presentation" style="border:none;border-radius:8px;font-style:normal;height:48px;background:#0c6cf2" valign="middle">
                                                  <a href="<?php echo e(env('APP_URL')); ?>/reset/password/<?php echo e($md['username']); ?>/<?php echo e($md['token']); ?>" style="display:inline-block;background:#0c6cf2;color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-style:normal;font-weight:600;line-height:150%;margin:0;text-decoration:none;text-transform:none;padding:0 15px;border-radius:8px" target="_blank" > Reset Password </a>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
                                      ...
                                      <tr>
                                        <td align="left" class="m_-3249132211638951850p m_-3249132211638951850fw500 m_-3249132211638951850blue-dark" style="font-size:0px;padding:0;padding-top:16px;word-break:break-word">
                                          <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000">
                                            <p class="m_-3249132211638951850p m_-3249132211638951850fw500 m_-3249132211638951850blue-dark">If you were not the one that requested for this password reset, please Contact support now: <?php echo e(env('SUPPORT_EMAIL')); ?> for a quick action. </p>
                                          </div>
                                        </td>
                                      </tr>
                                    </tbody>
                            ...
                            <tbody>
                              <tr>
                                <td align="left" class="m_-3249132211638951850h3 m_-3249132211638951850gray" style="font-size:0px;padding:0;word-break:break-word">
                                  <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000"><span class="m_-3249132211638951850h3 m_-3249132211638951850gray">© olympustrusttrade.com Investment - Thanks for Using Us.</span></div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
...
</html><?php /**PATH /home/metawfal/olympustrusttrade.com/core/resources/views/mail/pwd_req.blade.php ENDPATH**/ ?>